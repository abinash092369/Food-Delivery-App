        ...
        <div className="bg-white rounded-2xl border border-slate-100 p-6 md:p-10 shadow-sm hover:shadow-md transition-all duration-300 space-y-8">
          ...
          <div className="prose prose-slate max-w-none">
            <p className="text-slate-600 leading-relaxed">
              At éets, your privacy is our top priority. This Privacy Policy describes how éets Food Technologies Private Limited collects, uses, and shares your personal information when you use our services.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="text-slate-600 text-sm md:text-base space-y-3 pl-2 border-l-2 border-teal-500/30">
              <p>
                To deliver food fresh and fast, éets requires access to your location details:
              </p>
              <ul className="list-disc pl-5 space-y-1">
          ...
          <div className="space-y-4">
            ...
            <div className="text-slate-600 text-sm md:text-base space-y-3 pl-2 border-l-2 border-teal-500/30">
              ...
              <ul className="list-disc pl-5 space-y-1">
                <li>éets does not directly store credit/debit card numbers or net banking passwords on our servers.</li>
          ...
          <div className="space-y-4">
            ...
            <div className="text-slate-600 text-sm md:text-base space-y-3 pl-2 border-l-2 border-teal-500/30">
              ...
              <ul className="list-disc pl-5 space-y-1">
                <li>**Access & Export:** Request a copy of all personal details éets holds about you.</li>
          ...
          <div className="space-y-4">
            ...
            <div className="text-slate-600 text-sm md:text-base space-y-3 pl-2 border-l-2 border-teal-500/30">
              ...
              <p className="font-semibold text-textMain mt-2">
                éets Food Technologies Private Limited
              </p>
