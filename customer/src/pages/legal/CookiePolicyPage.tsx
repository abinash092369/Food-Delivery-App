      ...
      <section className="relative bg-gradient-to-br from-navy via-[#0c4a6e] to-[#042f2e] py-16 px-4 text-center border-b border-slate-900 shadow-md">
        ...
        <div className="max-w-4xl mx-auto space-y-4 relative z-10">
          ...
          <p className="text-slate-300 text-sm md:text-base max-w-xl mx-auto">
            Last updated: June 12, 2026. Understand how we use cookies and browser storage to optimize éets.
          </p>
        </div>
      </section>
        ...
        <div className="bg-white rounded-2xl border border-slate-100 p-6 md:p-10 shadow-sm hover:shadow-md transition-all duration-300 space-y-8">
          ...
          <div className="prose prose-slate max-w-none">
            <p className="text-slate-600 leading-relaxed">
              To make your food ordering experience as smooth as possible, the éets customer platform uses cookies, local browser storage, and other tracking technologies. This Cookie Policy explains what these technologies are and how you can manage them.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="text-slate-600 text-sm md:text-base space-y-3 pl-2 border-l-2 border-teal-500/30">
              <p>
                These cookies are absolutely necessary for the éets customer application to function and cannot be turned off:
              </p>
          ...
          <div className="space-y-4">
            ...
            <p className="text-slate-600 text-sm md:text-base pl-2 border-l-2 border-teal-500/30 leading-relaxed">
              You can block or delete cookies through your web browser preferences (such as Chrome, Safari, Edge, or Firefox settings). However, please note that blocking essential cookies will make it impossible to sign in, use the cart drawer, or place orders on éets.
            </p>
          </div>
