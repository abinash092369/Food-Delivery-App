      ...
      <section className="relative bg-gradient-to-br from-navy via-[#0c4a6e] to-[#042f2e] py-16 px-4 text-center border-b border-slate-900 shadow-md">
        ...
        <div className="max-w-4xl mx-auto space-y-4 relative z-10">
          ...
          <p className="text-slate-300 text-sm md:text-base max-w-xl mx-auto">
            Last updated: June 12, 2026. Please read these terms carefully before using the éets platform.
          </p>
        </div>
      </section>
        ...
        <div className="bg-white rounded-2xl border border-slate-100 p-6 md:p-10 shadow-sm hover:shadow-md transition-all duration-300 space-y-8">
          ...
          <div className="prose prose-slate max-w-none">
            <p className="text-slate-600 leading-relaxed">
              Welcome to éets. These Terms & Conditions govern your access to and use of our website, mobile application, and related services (collectively, the "Platform") operated by éets Food Technologies Private Limited.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="text-slate-600 text-sm md:text-base space-y-3 pl-2 border-l-2 border-teal-500/30">
              <p>
                To utilize the core ordering features of éets, you must create a verified account. By registering, you agree to:
              </p>
          ...
          <div className="space-y-4">
            ...
            <div className="text-slate-600 text-sm md:text-base space-y-3 pl-2 border-l-2 border-teal-500/30">
              <p>
                éets provides a platform connecting customers with registered vendor restaurants.
              </p>
              <ul className="list-disc pl-5 space-y-1">
          ...
          <div className="space-y-4">
            ...
            <div className="text-slate-600 text-sm md:text-base space-y-3 pl-2 border-l-2 border-teal-500/30">
              <p>
                éets enforces a strict cancellation policy to support our partner kitchens and delivery riders:
              </p>
              <ul className="list-disc pl-5 space-y-1">
          ...
          <div className="space-y-4">
            ...
            <div className="text-slate-600 text-sm md:text-base space-y-3 pl-2 border-l-2 border-teal-500/30">
              <p>
                By using the éets customer app, you agree **not** to:
              </p>
              <ul className="list-disc pl-5 space-y-1">
                <li>Conduct fraudulent transactions or create fake accounts to abuse coupon codes.</li>
                <li>Collect data or scrape content from the éets app for commercial purposes.</li>
