        ...
        <div className="bg-white rounded-2xl border border-slate-100 p-6 md:p-10 shadow-sm hover:shadow-md transition-all duration-300 space-y-8">
          ...
          <div className="prose prose-slate max-w-none">
            <p className="text-slate-600 leading-relaxed">
              éets is dedicated to providing efficient, hygienic, and swift delivery of meals from local kitchens straight to your hands. This Delivery Policy explains our operational framework, timelines, and handler policies.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="text-slate-600 text-sm md:text-base space-y-3 pl-2 border-l-2 border-teal-500/30">
              <p>
                éets prides itself on real-time transparency:
              </p>
              <ul className="list-disc pl-5 space-y-1">
          ...
          <div className="space-y-4">
            ...
            <div className="text-slate-600 text-sm md:text-base space-y-3 pl-2 border-l-2 border-teal-500/30">
              ...
              <ul className="list-disc pl-5 space-y-1">
                <li>We dispatch the request to nearby verified éets delivery partners.</li>
