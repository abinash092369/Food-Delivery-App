        ...
        <div className="bg-white rounded-2xl border border-slate-100 p-6 md:p-10 shadow-sm hover:shadow-md transition-all duration-300 space-y-8">
          ...
          <div className="prose prose-slate max-w-none">
            <p className="text-slate-600 leading-relaxed">
              At éets, we prioritize fair transactions. This Refund & Cancellation Policy outlines when you are eligible for refunds, our cancellation rules, and how long processing takes.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="text-slate-600 text-sm md:text-base space-y-3 pl-2 border-l-2 border-teal-500/30">
              ...
              <ul className="list-disc pl-5 space-y-1">
                <li>**éets Fault (Rider unavailable, weather delay cancellations):** 100% refund.</li>
          ...
          <div className="space-y-4">
            ...
            <p className="text-slate-600 text-sm md:text-base pl-2 border-l-2 border-teal-500/30 leading-relaxed">
              If your bank account was debited multiple times due to a gateway lag, the duplicate payments are flagged automatically by éets. The excess amount will be auto-credited to your account. You can also send a ticket via the **Report an Issue** page with screenshots of your passbook or bank SMS statement.
            </p>
          </div>
