...
export const HelpCenterPage: React.FC = () => {
  ...
  const faqData: Record<typeof activeTopic, FAQItem[]> = {
    faqs: [
      { q: 'How does éets deliver food so fast?', a: 'We partner with restaurants that prioritize preparation times, and utilize an automated routing algorithm to assign the nearest delivery partner to your order.' },
      { q: 'Is there a minimum order value?', a: 'No, éets does not enforce a minimum order value. However, orders below ₹100 may incur a small cart value fee.' },
    ...
    ordering: [
      ...
      { q: 'Can I schedule an order for later?', a: 'Currently, éets operates on an on-demand immediate delivery basis. Scheduled deliveries will be introduced in future updates.' }
    ],
    payment: [
      ...
      { q: 'Can I pay via Cash on Delivery (COD)?', a: 'To maintain rider safety and zero-contact hygiene protocols, éets operates strictly on pre-paid online transactions.' }
    ],
    delivery: [
    ...
    account: [
      ...
      { q: 'Can I delete my éets account permanently?', a: 'Yes. Navigate to Profile > Settings > Delete Account. Please note this will permanently erase your order history and saved addresses.' },
      { q: 'Why am I not receiving notification alerts?', a: 'Please ensure that éets browser/app notifications are allowed in your device settings. Also check the Notifications tab in the navbar.' }
    ]
  }
