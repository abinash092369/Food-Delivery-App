    ...
    <footer className="relative bg-gradient-to-b from-[#0f172a] to-[#090d16] text-white border-t border-slate-800 mt-auto pt-16 pb-8 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-12 pb-12 border-b border-slate-800/80">
          ...
          <div className="space-y-5 lg:col-span-1">
            <Link to="/" className="flex items-center gap-2">
              <img src="/logo.jpg" alt="EETS Logo" className="w-8 h-8 object-contain rounded-lg shadow-md" />
              <span className="text-2xl font-heading font-extrabold text-primary tracking-wider">EETS</span>
            </Link>
            <p className="text-slate-400 text-xs md:text-sm leading-relaxed">
              Fresh food delivered fast from trusted local restaurants. Discover your favorite meals, track orders in real time, and enjoy a seamless food delivery experience with EETS.
            </p>
        ...
        <div className="pt-8 text-center text-xs text-slate-500 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p>© 2026 EETS Food Technologies Private Limited. All Rights Reserved.</p>
