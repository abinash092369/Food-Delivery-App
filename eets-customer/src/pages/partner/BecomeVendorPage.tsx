...
export const BecomeVendorPage: React.FC = () => {
  ...
  const onboardingSteps = [
    ...
    },
    {
      ...
      desc: 'Login to the EETS Vendor App, set your kitchen status to Active, and start receiving orders from riders.',
    },
  ]
  ...
  const benefits = [
    ...
    },
    {
      ...
      desc: 'Rely on EETS’ professional delivery fleet. No need to hire your own drivers—we handle all coordination.',
    },
  ]
      ...
      <section className="relative bg-gradient-to-br from-navy via-[#0c4a6e] to-[#042f2e] py-20 px-4 text-center border-b border-slate-900 shadow-md">
        ...
        <div className="max-w-4xl mx-auto space-y-6 relative z-10">
          ...
          <h1 className="font-heading text-4xl md:text-5xl font-extrabold text-white tracking-tight leading-tight">
            ...
            With <span className="bg-gradient-to-r from-accent to-teal-400 bg-clip-text text-transparent">EETS Restaurant Partner</span>
          </h1>
          ...
          {formSubmitted ? (
            <div className="bg-teal-50 border border-teal-200/50 rounded-2xl p-8 text-center space-y-4 animate-fade-in">
              ...
              <p className="text-sm text-slate-600 max-w-md mx-auto">
                Thank you for applying to EETS. Our representative will contact you on **{formData.phone}** or email you at **{formData.email}** shortly to verify documents.
              </p>
              <button
