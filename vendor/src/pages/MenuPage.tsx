          ...
          {categoriesData.map((catWrap, idx) => {
            ...
            return (
              ...
              >
                ...
                {/* Category Header */}
                <div className="p-4 bg-gray-50/50 hover:bg-gray-50 flex flex-col md:flex-row md:items-center justify-between gap-4 transition-colors">
                  <div 
                  ...
                  {/* Actions / Sorting */}
                  <div className="flex flex-wrap items-center gap-2 w-full md:w-auto justify-start md:justify-end border-t md:border-t-0 pt-3 md:pt-0">
                    <button
                      disabled={idx === 0}
                ...
                {isExpanded && (
                  <div className="border-t border-gray-100 p-4 space-y-4 bg-white divide-y divide-gray-50">
                    {items.map((item) => (
                      <div 
                        key={item.id} 
                        className="pt-4 first:pt-0 flex flex-col sm:flex-row sm:items-center justify-between gap-4 text-sm group border-b border-gray-50 pb-4 last:border-b-0"
                      >
                        {/* Item Info */}
                        ...
                        {/* Item Controls */}
                        <div className="flex flex-wrap items-center gap-3 w-full sm:w-auto justify-start sm:justify-end bg-gray-50 sm:bg-transparent p-2.5 sm:p-0 rounded-xl">
                          {/* Availability Toggle */}
                          <button
